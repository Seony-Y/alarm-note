...
- 주간 캘린더, 알람 추가, 알람 켜기·끄기를 제공하는 4×2 Android 홈 화면 위젯
...
앱을 한 번 실행해 일정을 불러온 다음 홈 화면을 길게 눌러 **위젯 > 하루알람**을 선택합니다. 4×2 위젯은 현재 주간 캘린더와 다음 일정 2개를 표시합니다. 추가 버튼은 새 일정 화면을 열고, 각 일정의 버튼은 앱을 열어 알람 상태를 안전하게 변경합니다. 일정 추가, 수정, 완료 또는 알람 상태 변경 시 내용이 갱신됩니다.
